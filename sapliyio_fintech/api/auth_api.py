...
class AuthApi:
    ...
    def validate_key(
        ...
        :param validate_key_request: (required)
        :type validate_key_request: ValidateKeyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._validate_key_serialize(
            validate_key_request=validate_key_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def validate_key_with_http_info(
        self,
        validate_key_request: ValidateKeyRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ValidateKey200Response]:
        """Validate an API key
    ...
    @validate_call
    def validate_key_without_preload_content(
        self,
        validate_key_request: ValidateKeyRequest,
        _request_timeout: Union[
            None,
    ...
    def _validate_key_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if validate_key_request is not None:
            _body_params = validate_key_request
