...
class ZonesApi:
    ...
    def create_zone(
        ...
        :param create_zone_request: (required)
        :type create_zone_request: CreateZoneRequest
    ...
    def create_zone_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListZones200ResponseInner]:
        """Create a Zone
    ...
    def _create_zone_serialize(
        ...
        if create_zone_request is not None:
            _body_params = create_zone_request
    ...
    def list_zones(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ListZones200ResponseInner]:
        """List or Get Zones
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ListZones200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_zones_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListZones200ResponseInner]]:
        """List or Get Zones
