...
class ExecutionsApi:
    ...
    def _get_execution_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/executions/{executionId}',
    ...
    def resume_execution(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResumeExecution200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def resume_execution_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResumeExecution200Response]:
        """Resume a paused Execution
    ...
    def _resume_execution_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/executions/{executionId}/resume',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
