...
class BillingSubscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "plan_id", "current_period_end"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['active', 'canceled', 'past_due', 'incomplete']):
            raise ValueError("must be one of enum values ('active', 'canceled', 'past_due', 'incomplete')")
        return value
