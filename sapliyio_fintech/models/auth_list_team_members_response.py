...
class AuthListTeamMembersResponse(BaseModel):
    """
    AuthListTeamMembersResponse
    """ # noqa: E501
    memberships: Optional[List[AuthMembership]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memberships": [AuthMembership.from_dict(_item) for _item in obj["memberships"]] if obj.get("memberships") is not None else None
        })
        return _obj
