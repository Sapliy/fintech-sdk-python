...
class BillingListSubscriptionsResponse(BaseModel):
    """
    BillingListSubscriptionsResponse
    """ # noqa: E501
    subscriptions: Optional[List[BillingSubscription]] = None
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    __properties: ClassVar[List[str]] = ["subscriptions", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [BillingSubscription.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
