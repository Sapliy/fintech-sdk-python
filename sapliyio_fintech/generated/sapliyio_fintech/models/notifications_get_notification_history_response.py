...
class NotificationsGetNotificationHistoryResponse(BaseModel):
    """
    NotificationsGetNotificationHistoryResponse
    """ # noqa: E501
    notifications: Optional[List[NotificationsNotification]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notifications": [NotificationsNotification.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
