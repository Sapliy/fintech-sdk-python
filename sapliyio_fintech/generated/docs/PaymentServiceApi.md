# sapliyio_fintech.PaymentServiceApi
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    ...
    api_instance = sapliyio_fintech.PaymentServiceApi(api_client)
    id = 'id_example' # str | 
    body = sapliyio_fintech.PaymentServiceConfirmPaymentIntentBody() # PaymentServiceConfirmPaymentIntentBody | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.PaymentServiceApi(api_client)
    body = sapliyio_fintech.PaymentsCreatePaymentIntentRequest() # PaymentsCreatePaymentIntentRequest | 
