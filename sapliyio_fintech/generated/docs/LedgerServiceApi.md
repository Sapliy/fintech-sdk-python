# sapliyio_fintech.LedgerServiceApi
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    ...
    api_instance = sapliyio_fintech.LedgerServiceApi(api_client)
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.LedgerServiceApi(api_client)
    body = sapliyio_fintech.LedgerRecordTransactionRequest() # LedgerRecordTransactionRequest | 
