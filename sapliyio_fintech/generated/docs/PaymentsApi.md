...
[**get_payment_intent**](PaymentsApi.md#get_payment_intent) | **GET** /v1/payments/{id} | Get Payment Intent details
...
# **get_payment_intent**
> PaymentIntent get_payment_intent(id, x_zone_id, x_zone_mode=x_zone_mode)
...
with sapliyio_fintech.generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Payment Intent details
        api_response = api_instance.get_payment_intent(id, x_zone_id, x_zone_mode=x_zone_mode)
        print("The response of PaymentsApi->get_payment_intent:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentsApi->get_payment_intent: %s\n" % e)
```
