# sapliyio_fintech.WalletServiceApi
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    ...
    api_instance = sapliyio_fintech.WalletServiceApi(api_client)
    body = sapliyio_fintech.WalletCreateWalletRequest() # WalletCreateWalletRequest | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.WalletServiceApi(api_client)
    body = sapliyio_fintech.WalletTopUpRequest() # WalletTopUpRequest | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.WalletServiceApi(api_client)
    body = sapliyio_fintech.WalletTransferRequest() # WalletTransferRequest | 
