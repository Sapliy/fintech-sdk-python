# sapliyio_fintech.BillingServiceApi
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    ...
    api_instance = sapliyio_fintech.BillingServiceApi(api_client)
    id = 'id_example' # str | 
    body = None # object | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.BillingServiceApi(api_client)
    body = sapliyio_fintech.BillingCreateSubscriptionRequest() # BillingCreateSubscriptionRequest | 
