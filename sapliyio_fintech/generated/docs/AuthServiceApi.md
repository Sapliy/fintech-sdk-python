# sapliyio_fintech.AuthServiceApi
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.AuthServiceApi(api_client)
    body = sapliyio_fintech.AuthCreateSSOProviderRequest() # AuthCreateSSOProviderRequest | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.AuthServiceApi(api_client)
    body = sapliyio_fintech.AuthInitiateSSORequest() # AuthInitiateSSORequest | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.AuthServiceApi(api_client)
    body = sapliyio_fintech.AuthValidateKeyRequest() # AuthValidateKeyRequest | 
...
with sapliyio_fintech.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sapliyio_fintech.AuthServiceApi(api_client)
    body = sapliyio_fintech.AuthValidateTokenRequest() # AuthValidateTokenRequest | 
