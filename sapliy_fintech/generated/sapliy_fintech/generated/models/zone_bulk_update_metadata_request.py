...
class ZoneBulkUpdateMetadataRequest(BaseModel):
    """
    ZoneBulkUpdateMetadataRequest
    """ # noqa: E501
    zone_ids: Optional[List[StrictStr]] = Field(default=None, alias="zoneIds")
    metadata: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["zoneIds", "metadata"]
