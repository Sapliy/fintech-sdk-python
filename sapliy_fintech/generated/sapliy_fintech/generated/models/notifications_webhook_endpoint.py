...
class NotificationsWebhookEndpoint(BaseModel):
    """
    NotificationsWebhookEndpoint
    """ # noqa: E501
    id: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    enabled_events: Optional[List[StrictStr]] = Field(default=None, alias="enabledEvents")
    secret: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    created_at: Optional[StrictStr] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "url", "enabledEvents", "secret", "status", "createdAt"]
