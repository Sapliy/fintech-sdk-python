...
class AuthGetAuditLogsResponse(BaseModel):
    """
    AuthGetAuditLogsResponse
    """ # noqa: E501
    logs: Optional[List[AuthAuditLog]] = None
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    __properties: ClassVar[List[str]] = ["logs", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [AuthAuditLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
