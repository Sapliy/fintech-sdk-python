...
class ZoneZone(BaseModel):
    ...
    publishable_key: Optional[StrictStr] = Field(default=None, alias="publishableKey")
    status: Optional[StrictStr] = None
    template_name: Optional[StrictStr] = Field(default=None, alias="templateName")
    metadata: Optional[Dict[str, StrictStr]] = None
    created_at: Optional[StrictStr] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "orgId", "name", "mode", "secretKey", "publishableKey", "status", "templateName", "metadata", "createdAt"]
