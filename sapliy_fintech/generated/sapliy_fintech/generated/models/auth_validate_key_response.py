...
class AuthValidateKeyResponse(BaseModel):
    """
    ...
    rate_limit_quota: Optional[StrictInt] = Field(default=None, alias="rateLimitQuota")
    zone_id: Optional[StrictStr] = Field(default=None, alias="zoneId")
    mode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["valid", "userId", "environment", "scopes", "orgId", "role", "rateLimitQuota", "zoneId", "mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orgId": obj.get("orgId"),
            "role": obj.get("role"),
            "rateLimitQuota": obj.get("rateLimitQuota"),
