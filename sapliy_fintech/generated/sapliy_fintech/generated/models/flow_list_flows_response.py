...
class FlowListFlowsResponse(BaseModel):
    """
    FlowListFlowsResponse
    """ # noqa: E501
    flows: Optional[List[FlowFlow]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flows": [FlowFlow.from_dict(_item) for _item in obj["flows"]] if obj.get("flows") is not None else None
        })
        return _obj
