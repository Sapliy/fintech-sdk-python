...
class NotificationsListWebhookEndpointsResponse(BaseModel):
    """
    NotificationsListWebhookEndpointsResponse
    """ # noqa: E501
    endpoints: Optional[List[NotificationsWebhookEndpoint]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoints": [NotificationsWebhookEndpoint.from_dict(_item) for _item in obj["endpoints"]] if obj.get("endpoints") is not None else None
        })
        return _obj
